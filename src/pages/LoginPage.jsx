...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Automatically logout when landing on login page (per requirements)
    logout();
  }, [logout]);
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Backup: If _id is missing in response body, extract it from token payload
  ...
  return (
    <>
      <PageMeta
        title="Login | Grievance Redressal System"
        description="Login to Grievance Redressal System Admin Panel"
      />
